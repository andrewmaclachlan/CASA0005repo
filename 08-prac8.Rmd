...
* Here as we have logged the median house price we must follow the rules...
  ...
  * For every 1% increase in the independent variable the dependent increases by around 0.09 points 
  
  Before a 1 unit in median house price absence meant GCSE scores improved by 12.65 points, now they just improve by 9.29 points.
