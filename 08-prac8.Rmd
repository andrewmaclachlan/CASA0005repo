...
In the sparse example, there are two examples different arguments, this is a beyond the scope here but for reference.... 
...
**However**, when discussing this with Adam, he believes the coefficients can be compared as essentially you are still trying to model the same dependent variable...what do you think?
