...
1. Explain and execute appropriate pre-proessing steps of raster data
...
Next, we will aggregate our raster data to LSOAs, taking a mean of the pixles in each LSOA.
...
Joint them all together in two steps - make the side plots, then join that to the main plot
