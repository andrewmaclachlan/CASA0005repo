...
map <- ggplot() +
 geom_sf(data = data, mapping = aes(fill = bi_class), color=NA, lwd = 0.1, show.legend = FALSE) +
  ...
  geom_sf(data = manchester_MSOA, mapping = aes(fill=NA), color="black", size = .7, alpha = .75, show.legend = FALSE)+
...
all
dev.copy(device = png, filename = 'MyPlot.png', width = 687, height = 455) 
dev.off()
