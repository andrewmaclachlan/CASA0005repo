...
Before you move on consider what you have learnt about `dplyr` in relation to this concept map [by Greg Wilson](https://github.com/rstudio/concept-maps). The teaching team will also explain it...
...
```{r echo=FALSE, out.width = "500px", fig.align='center', cache=FALSE, fig.cap=" Types of join --- Source: [Tidy explain by Garrick Aden‑Buie](https://www.garrickadenbuie.com/project/tidyexplain/)"}
