...
**Note** this long string is the PROJ4 for British National Grid (EPSG 27700). In the past we could just specify "+init=epsg:27700". However now we must find the PROJ4 on the [EPSG website](https://epsg.io/27700)
