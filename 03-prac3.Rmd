...
```{r planar, fig.cap="Planar projections. Source: [Wikipedia (2023) ](https://en.wikipedia.org/wiki/Planar_projection)", out.width="49%", fig.show='hold', echo=FALSE, cache=FALSE}
