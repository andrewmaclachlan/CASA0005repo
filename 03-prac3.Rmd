...
* Assess the validity of your topic in terms of data suitability, then sketch out an introduction and literature review including academic and policy documents (or any reputable source) --- it's the same as last week!

* Go through the assignment examples on Moodle and mark them with the mark scheme.
...
Are you already competent with raster analysis and R, then have a go at completing this task in the practical session. 

1. Select a different city and create a histogram for average summer and average winter temperatures 
1. Summarise the data with a box or violin plot, [data-to-viz](https://www.data-to-viz.com/) will help.
