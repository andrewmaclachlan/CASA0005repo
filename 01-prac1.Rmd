...
**Assignment**
Each week we will provide some questions to test your knowledge, these should be used to guide your study for the module and final exam.

By the end of this week you should be able to answer the following questions:

* Provide an example of raster and vector data and describe why the data are provided in that format.

* Describe the benefits of QGIS and R.

* You have been given a `.csv` file containing some data and you also have a `.shp`. How do you join the non-spatial data to the spatial data. 
