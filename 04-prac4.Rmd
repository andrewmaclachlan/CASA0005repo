...
**Tip** the gender inequality has changed in the last year, with row titles (e.g. very high human development) think of a way you can remove these sub titles - perhaps filtering on a column value? or the ID?
