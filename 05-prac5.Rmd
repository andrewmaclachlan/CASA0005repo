...
```{r fig.cap="Map plan", out.width="100%", fig.show='hold', fig.pos = "C", echo=FALSE, cache=FALSE}
knitr::include_graphics("prac5_images/map_plan conv 1.png")
```

So...where do we begin

* Conceptually think of each section  as a **separate** object. For example, Hotels will be a London borough 'sf' object that has a column of Hotels.
